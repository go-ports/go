...
//go:build aix || darwin || dragonfly || freebsd || (js && wasm) || linux || netbsd || openbsd || solaris || windows || tamago
// +build aix darwin dragonfly freebsd js,wasm linux netbsd openbsd solaris windows tamago
